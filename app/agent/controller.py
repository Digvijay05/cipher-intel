"""Agent Controller - Central orchestration logic.
...
from app.intel import extract_intelligence, merge_intel_buffer
from app.scam_detector import detect_scam
from app.schemas.request import Message
from app.session import SessionState, get_session_store
...
class AgentController:
    ...
    def _generate_agent_notes(self, session: SessionState) -> str:
        ...
        if keywords:
            ...
            urgency_words = [k for k in keywords if k in ["urgent", "immediately", "urgent", "verify now"]]
